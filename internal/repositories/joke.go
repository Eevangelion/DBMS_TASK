...
type IJoke interface {
	...
	GetUserSubribedJokes(user_id int, page int, pageSize int, sort_mode string) (jokes []models.Joke, amount int, err error)
	...
	Create(joke *models.JokeRequest) (id int64, err error)
